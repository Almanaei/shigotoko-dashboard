    ...
    <div className="bg-white dark:bg-dark-card rounded-lg p-4 shadow-sm dark:shadow-card-dark animate-slide-in">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold text-blue-700 dark:text-blue-300">{displayStats.totalEmployees}</h3>
            </div>
        ...
        <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold text-emerald-700 dark:text-emerald-300">{displayStats.totalRevenue}</h3>
            </div>
        ...
        <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold text-amber-700 dark:text-amber-300">{displayStats.turnoverRate}</h3>
            </div>
        ...
        <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold text-purple-700 dark:text-purple-300">{displayStats.attendanceRate}</h3>
            </div>
      ...
      <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800/40 rounded-lg">
        <div className="flex justify-between items-center mb-2">
          ...
          <p className="text-xs font-medium text-blue-600 dark:text-blue-400">{displayStats.teamKPI}</p>
        </div>
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          <div 
            className="bg-blue-600 dark:bg-blue-500 h-2 rounded-full" 
            style={{ width: displayStats.teamKPI }}
          ></div>
        </div>
      </div>
    </div>
